        ...
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Admin Portal</h2>
                <p className="text-gray-600 dark:text-gray-300 text-sm">Sign in to access admin dashboard</p>
              </div>
            </div>
